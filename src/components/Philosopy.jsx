...
const Philosopy = () => {
  return (
    <div className="flex flex-col items-center">
      <div className="flex flex-col max-w-6xl items-center py-10 bg-[#090318] px-10">
        ...
        <Card className="bg-[#7b2cbf] border-none">
          <CardDescription className="text-white p-5">
            Your digital success story begins with a conversation. Reach out to
            us today to explore how Inwebmedia can partner with you to turn your
            vision into reality. Whether you’re taking your first step online or
            looking to elevate your existing digital presence, we’re here to
            make it happen.
          </CardDescription>
        </Card>
      </div>
